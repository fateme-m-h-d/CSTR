...
def main():
    ...
    for _, r in lin_df.iterrows():
        ...
        # -------------------------------------------------
        # Constraint 1: linearized nonlinear reaction balance
        # f = Cao - Ca - kf*Ca*Cb^2*tau + kr*Cc*tau = 0
        # Linear form:
        # aCao*Cao + aCa*Ca + aCb*Cb + aCc*Cc = b
        # -------------------------------------------------
        b_rxn = (
            -float(r["fss"])
        ...
        # -------------------------------------------------
        # Constraint 2: exact linear total mass balance
