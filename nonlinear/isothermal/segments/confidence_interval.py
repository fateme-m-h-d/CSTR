...
def plot_repeated_metric(summary, metric_name, ylabel, save_name, logy=False, use_pooled_nn=True):
    if summary.empty:
        return
...
def main():
    ...
    plot_repeated_metric(
        ...
        "pl_violation_vs_regions_1d.pdf",
        logy=True,
        use_pooled_nn=False,
    )
    plot_repeated_metric(
        ...
        "nonlinear_violation_vs_regions_1d.pdf",
        logy=True,
        use_pooled_nn=True,
    )
    ...
    plot_diagnostic(
        ...
        "linearization_mean_abs_error_vs_regions_1d.pdf",
        logy=True,
    )
    plot_diagnostic(
        diagnostics,
        ...
        "linearization_rmse_error_vs_regions_1d.pdf",
        logy=True,
    )
    plot_diagnostic(
        diagnostics,
        ...
        "linearization_max_abs_error_vs_regions_1d.pdf",
        logy=True,
    )
    ...
    plot_diagnostic(
        ...
        "projection_check_output_mae_scaled_vs_regions_1d.pdf",
        logy=True,
    )
    plot_diagnostic(
        diagnostics,
        ...
        "projection_check_pl_violation_vs_regions_1d.pdf",
        logy=True,
    )
    plot_diagnostic(
        diagnostics,
        ...
        "projection_check_nonlinear_violation_vs_regions_1d.pdf",
        logy=True,
    )
