...
loss_KKThPINN = np.load('./new1/data/learning_curves/cstr/KKThPINN/0.2/MODELID_train_losses_run0.npy') 
val_loss_KKThPINN = np.load('./new1/data/learning_curves/cstr/KKThPINN/0.2/MODELID_val_losses_run0.npy')  
violation_KKThPINN = np.load('./new1/data/learning_curves/cstr/KKThPINN/0.2/MODELID_train_violations_run0.npy')  
val_violation_KKThPINN = np.load('./new1/data/learning_curves/cstr/KKThPINN/0.2/MODELID_val_violations_run0.npy') 
