...
class NNOPT(nn.Module):
    ...
    def get_masks_2d(self, x, steepT=8e5, steepC=8e5, normalize=True):
        ...
        # must match number of fixed branches
    ...
    def forward(self, x, steepT=8e5, steepC=8e5):
        # NN
        x0 = x
        ...
        # 2D masks
        masks = self.get_masks_2d(x, steepT=steepT, steepC=steepC, normalize=True)
