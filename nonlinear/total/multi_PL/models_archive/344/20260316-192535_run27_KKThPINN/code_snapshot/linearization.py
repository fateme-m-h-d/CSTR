...
# ============================================================
def build_sampling_points(T_edges, C_edges, n_inner=25, seed=0, include_edge_midpoints=True):
...
T_samp, Cao_samp = build_sampling_points(T_edges, C_edges, n_inner=n_inner_per_region, seed=seed)
