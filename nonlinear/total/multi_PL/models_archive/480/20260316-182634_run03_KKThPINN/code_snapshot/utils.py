...
def LoadData(args):
    if args.dataset_type == 'cstr':
        ...
        C_edges_raw = np.linspace(0.8, 1.2, 3)  # example: 3 Cao-bins
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A_list = [
            torch.tensor([[-2.643131338401500e-03, 1.003889768050451e+00]], dtype=torch.float32),
            torch.tensor([[-3.202570648973200e-03, 1.003889768050451e+00]], dtype=torch.float32),
            torch.tensor([[-2.642650246403110e-02, 1.087270679508623e+00]], dtype=torch.float32),
            torch.tensor([[-3.015900656692750e-02, 1.087270679508623e+00]], dtype=torch.float32),
            torch.tensor([[-5.508114472305950e-02, 2.148741995664928e+00]], dtype=torch.float32),
            torch.tensor([[-6.106395582931040e-02, 2.148741995664928e+00]], dtype=torch.float32),
            torch.tensor([[-1.665129941346643e-01, 1.106552684773641e+01]], dtype=torch.float32),
            torch.tensor([[-1.835005061655605e-01, 1.106552684773641e+01]], dtype=torch.float32),
            torch.tensor([[-7.781757279623154e-01, 6.519585844280634e+01]], dtype=torch.float32),
            torch.tensor([[-8.552547005690485e-01, 6.519585844280634e+01]], dtype=torch.float32),
            torch.tensor([[-2.103441069650536e+00, 1.922389947196993e+02]], dtype=torch.float32),
            torch.tensor([[-2.308685917713909e+00, 1.922389947196993e+02]], dtype=torch.float32),
            torch.tensor([[-5.266885142832713e+00, 5.180188621624775e+02]], dtype=torch.float32),
            torch.tensor([[-5.774217736694311e+00, 5.180188621624775e+02]], dtype=torch.float32),
        ]

        self.B_list = [
        torch.tensor([[-1.027479668310577e+00, -2.507128764549310e-02, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-1.027271053317804e+00, -2.966876119424670e-02, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-1.553743755363481e+00, -4.921294243064790e-01, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-1.512422625468700e+00, -5.712447264475835e-01, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-6.609312411280623e+00, -4.797229539143125e+00, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-5.849606996429861e+00, -5.589308961767706e+00, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-5.186256967324327e+01, -4.253650316639818e+01, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-4.365837694366607e+01, -5.010032617609777e+01, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-3.549063143333340e+02, -2.909941286007695e+02, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-2.915695964444587e+02, -3.461812374163480e+02, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-1.116376343149529e+03, -9.077487779441620e+02, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-9.052107356980830e+02, -1.086580530022937e+03, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-3.178327976551730e+03, -2.560955283820424e+03, 0.000000000000000e+00]], dtype=torch.float32),
        torch.tensor([[-2.546203150709476e+03, -3.083387477240919e+03, 0.000000000000000e+00]], dtype=torch.float32),
    ]

        self.b_list = [
        torch.tensor([[-8.157818898116387e-01]], dtype=torch.float32),
        torch.tensor([[-9.868018739996445e-01]], dtype=torch.float32),
        torch.tensor([[-9.244047399044458e+00]], dtype=torch.float32),
        torch.tensor([[-1.052503297599399e+01]], dtype=torch.float32),
        torch.tensor([[-2.558393262978553e+01]], dtype=torch.float32),
        torch.tensor([[-2.811326320633342e+01]], dtype=torch.float32),
        torch.tensor([[-1.152270154848747e+02]], dtype=torch.float32),
        torch.tensor([[-1.249286234787867e+02]], dtype=torch.float32),
        torch.tensor([[-6.563248572326095e+02]], dtype=torch.float32),
        torch.tensor([[-7.086170871246246e+02]], dtype=torch.float32),
        torch.tensor([[-1.924785724421492e+03]], dtype=torch.float32),
        torch.tensor([[-2.075277564340714e+03]], dtype=torch.float32),
        torch.tensor([[-5.168491518941336e+03]], dtype=torch.float32),
        torch.tensor([[-5.566742688454306e+03]], dtype=torch.float32),
    ]
