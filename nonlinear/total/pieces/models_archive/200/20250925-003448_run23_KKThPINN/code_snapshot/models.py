...
class NNOPT(nn.Module):
    ...
    def get_masks(self, x, transition_points=[0.375, 0.425, 0.45, 0.5, 0.575, 0.625, 0.6625, 0.6875, 0.70625, 0.7225, 0.7375], steepness=800000):
    ...
    def forward(self, x, transition_points=[0.375, 0.425, 0.45, 0.5, 0.575, 0.625, 0.6625, 0.6875, 0.70625, 0.7225, 0.7375], steepness=800000):
        x0 = x                                             # input               
