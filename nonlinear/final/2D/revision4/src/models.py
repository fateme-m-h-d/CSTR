...
class NNOPT(nn.Module):
    def __init__(
        ...
        matrix_dtype = A_list[0].dtype
        
        self.register_buffer("T_edges", torch.as_tensor(T_edges, dtype=matrix_dtype))
        self.register_buffer("C_edges", torch.as_tensor(C_edges, dtype=matrix_dtype))
