...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.B = torch.tensor([[ 1, 0, 0, -10*1.001, +10*1.001]
                                ])  #changed
        self.b = torch.tensor([1*1.001])    #changed
...
def get_violation(args, data, X, pred):
    ...
    A = A * scaler.scale_[0]
    B = B * torch.tensor([scaler.scale_[1], scaler.scale_[2], scaler.scale_[3], scaler.scale_[4], scaler.scale_[5]])
    b = b
