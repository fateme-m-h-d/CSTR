...
from train import run_training, run_training_staged, evaluate_model
import argparse
import time
import copy
...
def add_arguments():
    ...
    parser.add_argument('--warmup_epochs', type=int, default=0,
                    help='Number of epochs to train NN first, then switch to KKThPINN.')
    parser.add_argument('--switch_mode', type=str, default='hard', choices=['hard', 'smooth'],
                        help='hard: switch instantly. smooth: blend NN -> KKThPINN during blend_epochs.')
    parser.add_argument('--blend_epochs', type=int, default=0,
                        help='Only used if switch_mode=smooth. Number of blending epochs.')
