...
# Prefer the newer training script if present.
...
def add_arguments():
    ...
    # Optional: unrolled consistency steps inside NNOPT
    parser.add_argument('--proj_iters', type=int, default=0,
                        help='Number of unrolled steps: project → recompute f,g (0 disables)')
    parser.add_argument('--debug_delta', action='store_true',
                        help='Print mean |delta| between basis and projected z5 (debug)')
