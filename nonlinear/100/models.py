...
class NNOPT(nn.Module):
    ...
    def custom_sigmoid(self, x, transition_point=0.45, steepness=30):
    ...
    def forward(self, x):
        ...
        # Apply sigmoid to x
        sigmoid_output = self.custom_sigmoid(x0)

        # Dot product of z and sigmoid_output
        final_output = torch.mul(z, sigmoid_output)
