...
def main():
    # Path to your CSV file with columns: Iteration, NN_Error, KKT_Error
    csv_file_path = r"C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/300/training_epoch_errors.csv"

    # Read the CSV file
    df = pd.read_csv(csv_file_path)

    # Extract the error columns
    nn_errors = df["NN_Training_Error"].values
    kkt_errors = df["KKThPINN_Training_Error"].values
