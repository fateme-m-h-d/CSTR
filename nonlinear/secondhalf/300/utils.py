...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/300"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-19.30542017704886]
                                ])  #changed
        self.B = torch.tensor([[ -11640.985384651969, -11639.985384648697, 0]
                                ])  #changed
        self.b = torch.tensor([-22676.094477735198])    #changed
