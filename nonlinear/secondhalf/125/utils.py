...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/125"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-18.775494569918237]
                                ])  #changed
        self.B = torch.tensor([[ -11438.799614238427, -11426.819084990699, 0]
                                ])  #changed
        self.b = torch.tensor([-22180.389946138283])    #changed
