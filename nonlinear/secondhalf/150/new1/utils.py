...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/150"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-19.606732841049677]
                                ])  #changed
        self.B = torch.tensor([[ -11847.788186858561, -11846.788186855154, 0]
                                ])  #changed
        self.b = torch.tensor([-23058.933505441164])    #changed
