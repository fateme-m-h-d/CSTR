...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/50"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-20.875879257060234]
                                ])  #changed
        self.B = torch.tensor([[ -12723.766867436025, -12722.76686743394, 0]
                                ])  #changed
        self.b = torch.tensor([-24676.944235457013])    #changed
