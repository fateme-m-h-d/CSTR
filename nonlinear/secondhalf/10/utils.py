...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/10"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-31.27614442856992]
                                ])  #changed
        self.B = torch.tensor([[ -20162.92927322244, -20161.929273236914, 0]
                                ])  #changed
        self.b = torch.tensor([-38224.58737211522])    #changed
