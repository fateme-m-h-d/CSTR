...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/secondhalf/5"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-19.010185892331066]
                                ])  #changed
        self.B = torch.tensor([[ -11438.799614238427, -11437.799614237163, 0]
                                ])  #changed
        self.b = torch.tensor([-22301.474735423344])    #changed
