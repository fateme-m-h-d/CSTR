...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/10"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.03302926866636774]
                                ])  #changed
        self.B = torch.tensor([[ -1.75179445290325, - 0.751794452903255, 0]
                                ])  #changed
        self.b = torch.tensor([-12.9699720827444])    #changed
