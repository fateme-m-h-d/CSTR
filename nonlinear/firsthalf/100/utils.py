...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/100"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.02879478968746971]
                                ])  #changed
        self.B = torch.tensor([[ -1.549379806828716, -0.5493798071408083, 0]
                                ])  #changed
        self.b = torch.tensor([-11.172181579708148])    #changed
