...
# === Configuration ===
base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/50"
...
def get_predictions(model_name):
    ...
    if model_name == "NN":
        model_path = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/50/new1/models/cstr/NN/0.2/MODELID_0.2_0.pth"
        model_type = "NN"
        A, B, b = None, None, None
    elif model_name == "KKThPINN":
        model_path = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/50/new1/models/cstr/KKThPINN/0.2/MODELID_0.2_0.pth"
    ...
    new_temperatures = np.linspace(280, 360, 50)  # 300 points
