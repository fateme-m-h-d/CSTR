...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/50"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.029239097364493802]
                                ])  #changed
        self.B = torch.tensor([[ -1.5674902340289147, -0.5674902340289146, 0]
                                ])  #changed
        self.b = torch.tensor([-11.354438935222431])    #changed
