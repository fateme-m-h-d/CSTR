...
def get_predictions(model_name):
    ...
    input_dim = 1
    hidden_dim = 30 #changed 
    hidden_num = 2
    z0_dim = 3

    # Choose model path and parameters based on model_name
    if model_name == "NN":
        model_path = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/lessnodes/30/150/new1/models/cstr/NN/0.2/MODELID_0.2_0.pth"
        model_type = "NN"
        A, B, b = None, None, None
    elif model_name == "KKThPINN":
        model_path = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/lessnodes/30/150/new1/models/cstr/KKThPINN/0.2/MODELID_0.2_0.pth"
