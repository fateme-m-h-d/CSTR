...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/lessnodes/25/150"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.028648140259396004]
                                ])  #changed
        self.B = torch.tensor([[ -1.5435375856528877, -0.5435375856528877, 0]
                                ])  #changed
        self.b = torch.tensor([-11.112310561969178])    #changed
