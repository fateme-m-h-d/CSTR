...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/5"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.02835702027443512]
                                ])  #changed
        self.B = torch.tensor([[ -1.5321325127042686, -0.5321325127042686, 0]
                                ])  #changed
        self.b = torch.tensor([-10.993866706229804])    #changed
