...
def load_data(dataset_path):
    ...
    base_dir = "C:/Users/Fateme/Desktop/Research/CSTR/nonlinear/firsthalf/200"   #new line of the code. need to change it.
...
class Data_cstr(data.Dataset):
    def __init__(self, dataset):
        ...
        self.A = torch.tensor([[-0.028575087932979467]
                                ])  #changed
        self.B = torch.tensor([[ -1.540651775038448, -0.5406517750384481, 0]
                                ])  #changed
        self.b = torch.tensor([-11.082538055208186])    #changed
