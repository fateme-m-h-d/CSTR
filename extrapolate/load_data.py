...
# T_limited = np.linspace(280, 360, 1000)
...
Cass = 0.350965898276802 #mol/L
Cbss = 0.701931796549271 #mol/L
Tss = 550.75075075075 #K
...
if __name__ == "__main__":
    ...
    new_temperatures = np.linspace(280, 700, 1000) #think about it
    ...
    plt.plot(new_temperatures, Cc_values1, color='g', label="Predicted Cc")
        ...
        # Define the range of T values
    n = 1000 #number of points
    T_values = np.linspace(280, 700, n)  # Adjust the range and number of points as needed
...
#     # Load the data
# file_path = './noisy_data.csv'
# data = pd.read_csv(file_path)

# # Define the columns to plot
# temperature = data['Temperature (T)']
# ca = data['Ca']
# cb = data['Cb']
# cc = data['Cc']
...
# # Plot Ca vs Temperature
# plt.plot(temperature, ca, label='Ca vs T', linestyle='-', marker='o')

# # Plot Cb vs Temperature
# plt.plot(temperature, cb, label='Cb vs T', linestyle='--', marker='s')

# # Plot Cc vs Temperature
# plt.plot(temperature, cc, label='Cc vs T', linestyle=':', marker='d')
