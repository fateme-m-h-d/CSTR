...
loss_KKThPINN = np.load('./data/learning_curves/cstr/KKThPINN/0.2/MODELID_train_losses_run0.npy')  # Replace with actual path to your loss file
val_loss_KKThPINN = np.load('./data/learning_curves/cstr/KKThPINN/0.2/MODELID_val_losses_run0.npy')  # Replace with actual path to your validation loss file
violation_KKThPINN = np.load('./data/learning_curves/cstr/KKThPINN/0.2/MODELID_train_violations_run0.npy')  # Replace with actual path to your violation file
val_violation_KKThPINN = np.load('./data/learning_curves/cstr/KKThPINN/0.2/MODELID_val_violations_run0.npy')  # Replace with actual path to your validation violation file
